...
BẠN PHẢI TRẢ VỀ DUY NHẤT MỘT CHUỖI JSON HỢP LỆ THEO ĐÚNG CẤU TRÚC SAU. TUYỆT ĐỐI KHÔNG BỌC TRONG BẤT KỲ THẺ MARKDOWN NÀO (KHÔNG DÙNG ```json ... ```), KHÔNG GIẢI THÍCH, KHÔNG CHÀO HỎI.
...
Cấu trúc JSON bắt buộc:
{
  ...
  "pronounsTable": [
    {
      "originalName": "string",
      "role": "Đặc điểm & Vai trò (ngắn gọn)",
      "narratorPronoun": "Đại từ ngôi thứ 3 (Narrator gọi, vd: hắn, gã, nàng, cậu)",
      "dialoguePronouns": "Xưng-Hô với nhân vật khác (vd: Với Mary: Anh - Em)",
      "notes": "Ghi chú sắc thái"
    }
  ],
  "glossaryTable": [
    {
      "englishTerm": "string (viết thường trịnh trọng, trừ tên riêng)",
      "vietnameseTranslation": "string (nghĩa tiếng Việt duy nhất chuẩn xác trong ngữ cảnh)",
      "contextNote": "Ghi chú văn cảnh"
    }
  ]
}
...
- Trích xuất tối đa 150 thuật ngữ được phân bố đều từ đầu đến cuối đoạn văn bản mẫu (phải chắt lọc những từ "đậm đặc" chất chuyên môn nhất). Đưa danh từ về số ít, động từ về nguyên thể. Sắp xếp Alphabetize.
